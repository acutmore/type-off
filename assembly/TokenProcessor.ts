...
//   }
  ...
  matchesContextualAtIndex(index: i32, contextualKeyword: ContextualKeyword): boolean {
    return (
  ...
  identifierNameAtIndex(index: i32): string {
...
//   }
  ...
  matches1AtIndex(index: i32, t1: TokenType): boolean {
...
//   }
  ...
  tokenAtRelativeIndex(relativeIndex: i32): Token {
