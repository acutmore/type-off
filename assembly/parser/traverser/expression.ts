...
function parseExprOp(startTokenIndex: i32, minPrec: i32, noIn: boolean): void {
    if (
      // isTypeScriptEnabled &&
      true &&
...
function parseSubscripts(startTokenIndex: i32, noCalls: boolean = false): void {
    // if (isFlowEnabled) {
...
export function baseParseSubscripts(startTokenIndex: i32, noCalls: boolean = false): void {
...
function parseSubscript(startTokenIndex: i32, noCalls: boolean, stopState: StopState): void {
    // if (isTypeScriptEnabled) {
    if (true) {
...
function parseAsyncArrowFromCallExpression(startTokenIndex: i32): void {
    // if (isTypeScriptEnabled) {
    if (true) {
      tsStartParseAsyncArrowFromCallExpression();
    // } else if (isFlowEnabled) {
...
export function parseMethod(functionStart: i32, isConstructor: boolean): void {
...
export function parseArrowExpression(startTokenIndex: i32): void {
...
export function parseFunctionBodyAndFinish(functionStart: i32, /*funcContextId: number = 0*/): void {
    // if (isTypeScriptEnabled) {
    if (true) {
