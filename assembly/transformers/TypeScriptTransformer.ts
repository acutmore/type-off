...
export default class TypeScriptTransformer {
  constructor(
  ...
  processEnumBody(enumName: string): void {
    ...
    // let lastValueReference;
    let lastValueReference: string | null = null;
    while (true) {
    ...
    //   let valueIsString: boolean;
      let valueIsString: boolean = false;
